...
from .forms import PostForm, CommentariesForm
...
class FeedbackCreateView(LoginRequiredMixin, CommentMixin, CreateView):
...
class FeedbackUpdateView(LoginRequiredMixin, EditCommentMixin, UpdateView):
    pass


class FeedbackDeleteView(LoginRequiredMixin, EditCommentMixin, DeleteView):
    pass
